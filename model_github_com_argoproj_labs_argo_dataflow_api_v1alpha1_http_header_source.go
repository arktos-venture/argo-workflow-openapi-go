...
// GithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource struct for GithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource
type GithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource struct {
...
func NewGithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource() *GithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource {
	this := GithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource{}
	return &this
}
...
func (o GithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource) MarshalJSON() ([]byte, error) {
...
type NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource struct {
	value *GithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource
	isSet bool
}

func (v NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource) Get() *GithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource {
	return v.value
}

func (v *NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource) Set(val *GithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource) {
	v.value = val
	v.isSet = true
}

func (v NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource) IsSet() bool {
	return v.isSet
}

func (v *NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource(val *GithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource) *NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource {
	return &NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource{value: val, isSet: true}
}

func (v NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1HTTPHeaderSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
