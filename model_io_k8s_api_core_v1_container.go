...
func (o IoK8sApiCoreV1Container) MarshalJSON() ([]byte, error) {
...
type NullableIoK8sApiCoreV1Container struct {
	value *IoK8sApiCoreV1Container
	isSet bool
}

func (v NullableIoK8sApiCoreV1Container) Get() *IoK8sApiCoreV1Container {
	return v.value
}

func (v *NullableIoK8sApiCoreV1Container) Set(val *IoK8sApiCoreV1Container) {
	v.value = val
	v.isSet = true
}

func (v NullableIoK8sApiCoreV1Container) IsSet() bool {
	return v.isSet
}

func (v *NullableIoK8sApiCoreV1Container) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIoK8sApiCoreV1Container(val *IoK8sApiCoreV1Container) *NullableIoK8sApiCoreV1Container {
	return &NullableIoK8sApiCoreV1Container{value: val, isSet: true}
}

func (v NullableIoK8sApiCoreV1Container) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIoK8sApiCoreV1Container) UnmarshalJSON(src []byte) error {
	v.isSet = true
