...
// GithubComArgoprojLabsArgoDataflowApiV1alpha1Expand struct for GithubComArgoprojLabsArgoDataflowApiV1alpha1Expand
type GithubComArgoprojLabsArgoDataflowApiV1alpha1Expand struct {
...
func NewGithubComArgoprojLabsArgoDataflowApiV1alpha1Expand() *GithubComArgoprojLabsArgoDataflowApiV1alpha1Expand {
	this := GithubComArgoprojLabsArgoDataflowApiV1alpha1Expand{}
	return &this
}
...
func (o GithubComArgoprojLabsArgoDataflowApiV1alpha1Expand) MarshalJSON() ([]byte, error) {
...
type NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1Expand struct {
	value *GithubComArgoprojLabsArgoDataflowApiV1alpha1Expand
	isSet bool
}

func (v NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1Expand) Get() *GithubComArgoprojLabsArgoDataflowApiV1alpha1Expand {
	return v.value
}

func (v *NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1Expand) Set(val *GithubComArgoprojLabsArgoDataflowApiV1alpha1Expand) {
	v.value = val
	v.isSet = true
}

func (v NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1Expand) IsSet() bool {
	return v.isSet
}

func (v *NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1Expand) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGithubComArgoprojLabsArgoDataflowApiV1alpha1Expand(val *GithubComArgoprojLabsArgoDataflowApiV1alpha1Expand) *NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1Expand {
	return &NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1Expand{value: val, isSet: true}
}

func (v NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1Expand) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGithubComArgoprojLabsArgoDataflowApiV1alpha1Expand) UnmarshalJSON(src []byte) error {
	v.isSet = true
