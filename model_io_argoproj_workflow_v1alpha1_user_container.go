...
func NewIoArgoprojWorkflowV1alpha1UserContainer(name string) *IoArgoprojWorkflowV1alpha1UserContainer {
	this := IoArgoprojWorkflowV1alpha1UserContainer{}
	this.Name = name
	return &this
}
...
// GetMirrorVolumeMounts returns the MirrorVolumeMounts field value if set, zero value otherwise.
func (o *IoArgoprojWorkflowV1alpha1UserContainer) GetMirrorVolumeMounts() bool {
	if o == nil || o.MirrorVolumeMounts == nil {
		var ret bool
		return ret
	}
	return *o.MirrorVolumeMounts
}

// GetMirrorVolumeMountsOk returns a tuple with the MirrorVolumeMounts field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IoArgoprojWorkflowV1alpha1UserContainer) GetMirrorVolumeMountsOk() (*bool, bool) {
	if o == nil || o.MirrorVolumeMounts == nil {
		return nil, false
	}
	return o.MirrorVolumeMounts, true
}
...
// SetMirrorVolumeMounts gets a reference to the given bool and assigns it to the MirrorVolumeMounts field.
func (o *IoArgoprojWorkflowV1alpha1UserContainer) SetMirrorVolumeMounts(v bool) {
	o.MirrorVolumeMounts = &v
}
...
func (o IoArgoprojWorkflowV1alpha1UserContainer) MarshalJSON() ([]byte, error) {
	...
	if o.MirrorVolumeMounts != nil {
		toSerialize["mirrorVolumeMounts"] = o.MirrorVolumeMounts
	}
	if true {
...
type NullableIoArgoprojWorkflowV1alpha1UserContainer struct {
	value *IoArgoprojWorkflowV1alpha1UserContainer
	isSet bool
}

func (v NullableIoArgoprojWorkflowV1alpha1UserContainer) Get() *IoArgoprojWorkflowV1alpha1UserContainer {
	return v.value
}

func (v *NullableIoArgoprojWorkflowV1alpha1UserContainer) Set(val *IoArgoprojWorkflowV1alpha1UserContainer) {
	v.value = val
	v.isSet = true
}

func (v NullableIoArgoprojWorkflowV1alpha1UserContainer) IsSet() bool {
	return v.isSet
}

func (v *NullableIoArgoprojWorkflowV1alpha1UserContainer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIoArgoprojWorkflowV1alpha1UserContainer(val *IoArgoprojWorkflowV1alpha1UserContainer) *NullableIoArgoprojWorkflowV1alpha1UserContainer {
	return &NullableIoArgoprojWorkflowV1alpha1UserContainer{value: val, isSet: true}
}

func (v NullableIoArgoprojWorkflowV1alpha1UserContainer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIoArgoprojWorkflowV1alpha1UserContainer) UnmarshalJSON(src []byte) error {
	v.isSet = true
