...
func NewIoArgoprojWorkflowV1alpha1Artifact(name string) *IoArgoprojWorkflowV1alpha1Artifact {
	this := IoArgoprojWorkflowV1alpha1Artifact{}
	this.Name = name
	return &this
}
...
func (o IoArgoprojWorkflowV1alpha1Artifact) MarshalJSON() ([]byte, error) {
...
type NullableIoArgoprojWorkflowV1alpha1Artifact struct {
	value *IoArgoprojWorkflowV1alpha1Artifact
	isSet bool
}

func (v NullableIoArgoprojWorkflowV1alpha1Artifact) Get() *IoArgoprojWorkflowV1alpha1Artifact {
	return v.value
}

func (v *NullableIoArgoprojWorkflowV1alpha1Artifact) Set(val *IoArgoprojWorkflowV1alpha1Artifact) {
	v.value = val
	v.isSet = true
}

func (v NullableIoArgoprojWorkflowV1alpha1Artifact) IsSet() bool {
	return v.isSet
}

func (v *NullableIoArgoprojWorkflowV1alpha1Artifact) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIoArgoprojWorkflowV1alpha1Artifact(val *IoArgoprojWorkflowV1alpha1Artifact) *NullableIoArgoprojWorkflowV1alpha1Artifact {
	return &NullableIoArgoprojWorkflowV1alpha1Artifact{value: val, isSet: true}
}

func (v NullableIoArgoprojWorkflowV1alpha1Artifact) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIoArgoprojWorkflowV1alpha1Artifact) UnmarshalJSON(src []byte) error {
	v.isSet = true
