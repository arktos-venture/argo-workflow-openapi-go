...
func (o IoK8sApiCoreV1Volume) MarshalJSON() ([]byte, error) {
...
type NullableIoK8sApiCoreV1Volume struct {
	value *IoK8sApiCoreV1Volume
	isSet bool
}

func (v NullableIoK8sApiCoreV1Volume) Get() *IoK8sApiCoreV1Volume {
	return v.value
}

func (v *NullableIoK8sApiCoreV1Volume) Set(val *IoK8sApiCoreV1Volume) {
	v.value = val
	v.isSet = true
}

func (v NullableIoK8sApiCoreV1Volume) IsSet() bool {
	return v.isSet
}

func (v *NullableIoK8sApiCoreV1Volume) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIoK8sApiCoreV1Volume(val *IoK8sApiCoreV1Volume) *NullableIoK8sApiCoreV1Volume {
	return &NullableIoK8sApiCoreV1Volume{value: val, isSet: true}
}

func (v NullableIoK8sApiCoreV1Volume) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIoK8sApiCoreV1Volume) UnmarshalJSON(src []byte) error {
	v.isSet = true
